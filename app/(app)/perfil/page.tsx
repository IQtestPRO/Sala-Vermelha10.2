...
import { Camera, Loader2, Save, Stethoscope, BrainCircuit, Lock, User, Phone, Mail, BadgeCheck, ChevronDown, GraduationCap, Lightbulb, BookMarked, BarChart3 } from "lucide-react";
  ...
  return (
    <>
      ...
      <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 18, paddingBottom: 28 }}>
        ...
        <Link href="/resumo" className="btn btn-ghost" style={{ minHeight: 46 }}>
