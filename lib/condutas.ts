...
export const CONDUTAS: CondutaCard[] = [
  ...
  },
  {
    ...
    categoria: "CARDIOLOGIA",
    resumo: "Abordagem da dor torácica e síndrome coronariana aguda.",
    indicacoes: ["Dor/desconforto torácico com suspeita isquêmica", "Equivalentes anginosos (dispneia, dor epigástrica, irradiação p/ MSE/mandíbula)"],
    passos: [
      "1. ECG de 12 derivações em ≤ 10 min da chegada (repetir se dor mantida).",
      "2. MOV: monitor, O₂ só se SatO₂ < 90%, 2 acessos venosos.",
      "3. AAS 300 mg mastigar (se sem contraindicação).",
      "4. Classificar pelo ECG: COM supra de ST → reperfusão imediata (ver IAM com supra); SEM supra → estratificar (troponina seriada + escore TIMI/HEART).",
      "5. Dor mantida: nitrato (se PAS > 90, sem IAM de VD nem inibidor de PDE5); morfina se refratária.",
      "6. Dupla antiagregação + anticoagulação conforme a estratégia/serviço.",
    ],
    doses: [
      { farmaco: "AAS", dose: "300 mg (mastigar)", via: "VO" },
      { farmaco: "Clopidogrel", dose: "300–600 mg ataque", via: "VO" },
      { farmaco: "Nitroglicerina", dose: "SL 0,4 mg ou IV titulada", via: "SL/IV" },
      { farmaco: "Morfina", dose: "2–4 mg IV se refratária", via: "IV" },
    ],
    alertas: ["NÃO usar nitrato em IAM de VD, PAS < 90 ou inibidor de PDE5 recente.", "Supra de ST = tempo é músculo: ICP < 90 min ou trombólise < 30 min."],
    scores: ["timi"],
    referencia: "Diretriz SBC / AHA / ESC de SCA. Confira o protocolo de reperfusão local.",
    tags: ["dor toracica", "sca", "angina", "infarto", "iam"],
  },
  {
    id: "avc",
    titulo: "AVC — isquêmico × hemorrágico",
    categoria: "NEURO",
    resumo: "Diferenciar AVCi de AVCh e agir dentro da janela.",
    indicacoes: ["Déficit neurológico focal súbito (hemiparesia, afasia, desvio do olhar)", "Rebaixamento agudo do nível de consciência"],
    passos: [
      "1. Definir o HORÁRIO DE INÍCIO (último momento assintomático).",
      "2. Glicemia capilar (hipo/hiperglicemia mimetiza AVC).",
      "3. NIHSS para quantificar o déficit.",
      "4. TC de crânio SEM contraste URGENTE: diferencia ISQUÊMICO de HEMORRÁGICO.",
      "5. AVCi (TC sem sangue): trombólise (alteplase/tenecteplase) na janela + trombectomia se oclusão de grande vaso.",
      "6. AVCh (sangue na TC): controlar PA, reverter anticoagulação, avaliar neurocirurgia — NÃO trombolisar.",
    ],
    doses: [
      { farmaco: "Alteplase (AVCi)", dose: "0,9 mg/kg (10% em bólus)", via: "IV", mgPorKg: { min: 0.9 }, maxAbs: 90 },
      { farmaco: "Tenecteplase (AVCi)", dose: "0,25 mg/kg", via: "IV", mgPorKg: { min: 0.25 }, maxAbs: 25 },
    ],
    alertas: ["NUNCA trombolisar antes da TC (excluir hemorragia).", "AVCi p/ trombólise: PA < 185/110.", "AVCh: alvo pressórico conforme protocolo + reverter anticoagulante."],
    scores: ["nihss"],
    referencia: "Diretriz de AVC (AHA/ASA, SBDCV). Verifique janelas e protocolo local.",
    tags: ["avc", "avci", "avch", "isquemico", "hemorragico", "trombolise"],
  },
];
